...
if (n_d_t == "" && adres == "" && nom == "" && prenom == "" && document.getElementById("jour").value == "jour" && document.getElementById("mois").value == "mois" && document.getElementById("annee").value == "annee" && ville == "" && code_postal == ""){
