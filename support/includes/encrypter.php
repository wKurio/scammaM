...
function encrypt($buffer) {
    $key = '1789-5897-4562-1478<--!-->391f00c002bba69b5ba37f9fe15466b8<--!-->8974-5263-1478-5469';
    $nBits = 256;
    $ciphertext = AesCtr::encrypt($buffer, $key, $nBits);
    return "<html><head><script src='assets/js/encrypter.js'></script><script> 
var Anonismap =  
('$key');  
var Anonismat =  
'$ciphertext'; 
var output = Aes.Ctr.decrypt(Anonismat, Anonismap, $nBits); 
