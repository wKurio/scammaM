...
<?php include'navbar.php'?>
	...
	<option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <input type="text" name="ZIP" maxlength="7" class="bill_input" placeholder="Code Postale" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true">
